...
labels = ["College", "Campus", "Department", "Employee Name", "Job Title", "Tenure", "Empl Class",  "Salary"]
    ...
    with open(html_path + html_file) as fp:
        ...
        while(curr_row):
            if len(curr_row.get_text(strip=True)) == 0:
                ...
                empl_class = employee_info[2].get_text(strip=True)
                ...
                if fte == 1:
                    new_employee =  (college, curr_campus, curr_dep, curr_employee, job_title, tenure, empl_class, salary) 
